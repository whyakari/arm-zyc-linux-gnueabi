...
enum opt_code
{
  ...
  /* OPT_mhard_float = 1990, */              /* -mhard-float */
  OPT_mlibarch_ = 1991,                      /* -mlibarch= */
  OPT_mlittle_endian = 1992,                 /* -mlittle-endian */
  OPT_mlong_calls = 1993,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1994,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1995,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1996,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1997,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1998,               /* -mprint-tune-info */
  OPT_mpure_code = 1999,                     /* -mpure-code */
  OPT_mrestrict_it = 2000,                   /* -mrestrict-it */
  OPT_msched_prolog = 2001,                  /* -msched-prolog */
  OPT_msingle_pic_base = 2002,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 2003,               /* -mslow-flash-data */
  /* OPT_msoft_float = 2004, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 2005, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 2006,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 2007,      /* -mstructure-size-boundary= */
  OPT_mthumb = 2008,                         /* -mthumb */
  OPT_mthumb_interwork = 2009,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 2010,                  /* -mtls-dialect= */
  OPT_mtp_ = 2011,                           /* -mtp= */
  OPT_mtpcs_frame = 2012,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 2013,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 2014,                         /* -mtune= */
  OPT_munaligned_access = 2015,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 2016,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 2017,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 2018,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 2019,              /* -mword-relocations */
  OPT_n = 2020,                              /* -n */
  ...
  OPT_truncate = 2158,                       /* -truncate */
  OPT_type_stats = 2159,                     /* -type-stats */
  OPT_u = 2160,                              /* -u */
  OPT_undef = 2161,                          /* -undef */
  OPT_v = 2162,                              /* -v */
  OPT_version = 2163,                        /* -version */
  OPT_w = 2164,                              /* -w */
  OPT_wrapper = 2165,                        /* -wrapper */
  OPT_x = 2166,                              /* -x */
  OPT_z = 2167,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
